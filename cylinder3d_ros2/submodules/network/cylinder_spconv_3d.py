...
class cylinder_asym(nn.Module):
    ...
    def forward(self, train_pt_fea_ten, train_vox_ten, batch_size, val=False):
        coords, features_3d = self.cylinder_3d_generator(train_pt_fea_ten, train_vox_ten, val = val)
