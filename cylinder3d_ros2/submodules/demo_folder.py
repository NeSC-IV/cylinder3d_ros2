...
if __name__ == '__main__':
    ...
    parser.add_argument('-y', '--config_path', default='config/semantickitti123.yaml')
    parser.add_argument('--demo-folder', type=str, default='/home/oliver/sequences/00/velodyne', help='path to the folder containing demo lidar scans', required=False)
    parser.add_argument('--save-folder', type=str, default='/home/oliver', help='path to save your result', required=False)
    parser.add_argument('--demo-label-folder', type=str, default='/home/oliver/demolab/', help='path to the folder containing demo labels')
